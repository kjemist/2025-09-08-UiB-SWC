...
instructor: ["Illimar Rekand", "Korbinian Bösl", "Jenny Ostrop", "Siri Kallhovd", "Michael Dondrup", "Dhanya Pushpadas", "Marco Foscato"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p>
  Please note that R and Python will be taught in parallell sessions on day 2, and as such it is not possible to attend both courses. <br>
  As such, the following schedule spans 5 days and not 6.
</p>
{% if site.carpentry == "swc" %}
